...
\date[September 25\textsuperscript{th}, 2024]{September 25\textsuperscript{th}, 2024}
...
\item The devices are both biased at the peak $\textrm{f}_{max}$\footnote[1]{$\textrm{f}_{T}$ or $\textrm{NF}_{min}$ may also be used, incurring a power consumption trade-off} current density
\item The devices have roughly the same threshold voltage
\end{enumerate}
\end{frame}
...
\caption{Auto-biasing circuit schematic.  $V_{\textrm{ddm}}$ is the replica mirror supply, nominally equal to 0.8 V. $V_{\textrm{ddc}}$ is the target circuit supply, \linebreak nominally equal to 0.8 V}
...
\caption[Measured target circuit current density versus temperature]{Measured target circuit current density versus temperature, with \linebreak 0.8 V supply voltage}
...
\caption[Measured target circuit output voltage versus temperature]{Measured target circuit output voltage versus temperature, with \linebreak 0.8 V supply voltage}
...
\caption{Comparison of simulated and measured current density of the target circuit, for $J_{mirror}$ = 250 $\upmu$A/$\upmu$m and \linebreak 0.8 V supply voltage}
...
\caption{Comparison of simulated and measured output voltage of the target circuit, for $J_{mirror}$ = 250 $\upmu$A/$\upmu$m and \linebreak 0.8 V supply voltage}
...
\item An LC tank circuit which can be used for determining the results of a quantum computation
...
\begin{itemize}
\item Measuring all the circuits at cryogenic temperatures
